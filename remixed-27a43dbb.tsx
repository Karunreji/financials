...
// Derived from your actual TB sheet — keyword → grouping
          ...
          <>
            ...
            <div style={{ marginTop: 24, background: "#1e293b", borderRadius: 12, padding: "16px 20px", borderLeft: "3px solid #6366f1" }}>
              ...
              <div style={{ fontSize: 12, color: "#64748b", lineHeight: 1.7 }}>
                ...
                <b style={{ color: "#93c5fd" }}>AI Match</b> — keyword engine matched the ledger name to a classification (e.g. "depreciation" → Tangible assets).&nbsp;
                ...
                <br />The classification engine uses <b style={{ color: "#94a3b8" }}>{CLASSIFICATION_RULES.length} keyword rules</b> covering {ALL_GROUPINGS.length} ledger groupings from your chart of accounts.
              </div>
            </div>
          </>
        )}
